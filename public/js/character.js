...
class Character {
	...
	createCharacter() {
		...
		const headMaterial=new THREE.MeshStandardMaterial( {
				color: 0xffdbac, emissive: 0xffdbac, emissiveIntensity: 0.5
			}
		...
		const bodyMaterial=new THREE.MeshStandardMaterial( {
				color: 0x3366ff, emissive: 0x3366ff, emissiveIntensity: 0.5
			}
		...
		const legMaterial=new THREE.MeshStandardMaterial( {
				color: 0x000066, emissive: 0x000066, emissiveIntensity: 0.5
			}
		...
		const shoeMaterial=new THREE.MeshStandardMaterial( {
				color: 0x000000, emissive: 0x000000, emissiveIntensity: 0.5
			}
